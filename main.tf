data "azurerm_key_vault_secret" "storage_account_key" {
  for_each     = { for k, v in var.stream_analytics_reference_input_blobs : k => v if v.storage_account_key_key_vault_id != null && v.storage_account_key_key_vault_secret_name != null }
